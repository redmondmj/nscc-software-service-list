...
def generate_report(data):
    ...
    for item in data:
        ...
        if "vmware" in name_lower or "hyper-v" in name_lower or "proxmox" in name_lower or "virtualbox" in name_lower:
        ...
        elif "windows server" in name_lower or "windows 1" in name_lower or "linux" in name_lower:
            categories["Operating Systems (Server & Client)"].append(item)
        elif "dhcp" in name_lower or "dns" in name_lower or "iis" in name_lower or "apache" in name_lower or "nginx" in name_lower or "samba" in name_lower or "linkrunner" in name_lower:
        ...
        elif "vs code" in name_lower or "python" in name_lower or "mysql" in name_lower or "postgresql" in name_lower or "mongodb" in name_lower or "putty" in name_lower or "draw.io" in name_lower:
